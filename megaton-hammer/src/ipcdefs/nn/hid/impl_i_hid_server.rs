...
impl<T: Object> IHidServer<T> {
	...
	// fn activate_npad_with_revision(&self, UNKNOWN) -> Result<UNKNOWN>;
	...
	// fn set_npad_joy_assignment_mode_single_with_destination(&self, UNKNOWN) -> Result<UNKNOWN>;
	...
	// fn send_vibration_gc_erm_command(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn get_actual_vibration_gc_erm_command(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn begin_permit_vibration_session(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn end_permit_vibration_session(&self, UNKNOWN) -> Result<UNKNOWN>;
	...
	// fn activate_seven_six_axis_sensor(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn start_seven_six_axis_sensor(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn stop_seven_six_axis_sensor(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn initialize_seven_six_axis_sensor(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn finalize_seven_six_axis_sensor(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn set_seven_six_axis_sensor_fusion_strength(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn get_seven_six_axis_sensor_fusion_strength(&self, UNKNOWN) -> Result<UNKNOWN>;
	...
	// fn has_battery(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn has_left_right_battery(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn get_npad_interface_type(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn get_npad_left_right_interface_type(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn get_palma_connection_handle(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn initialize_palma(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn acquire_palma_operation_complete_event(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn get_palma_operation_info(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn play_palma_activity(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn set_palma_fr_mode_type(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn read_palma_step(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn enable_palma_step(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn suspend_palma_step(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn reset_palma_step(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn read_palma_application_section(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn write_palma_application_section(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn read_palma_unique_code(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn set_palma_unique_code_invalid(&self, UNKNOWN) -> Result<UNKNOWN>;
