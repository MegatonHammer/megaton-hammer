...
impl<T: Object> IAdministrator<T> {
	...
	pub fn get_service_entry_requirement_cache(&self, ) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	#[cfg(feature = "switch-4.0.0")]
	pub fn invalidate_service_entry_requirement_cache(&self, ) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	#[cfg(feature = "switch-4.0.0")]
	pub fn invalidate_token_cache(&self, ) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	pub fn get_network_service_license_cache(&self, ) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	#[cfg(feature = "switch-5.0.0")]
	pub fn refresh_network_service_license_cache_async(&self, ) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	#[cfg(feature = "switch-5.0.0")]
	pub fn refresh_network_service_license_cache_async_if_seconds_elapsed(&self, ) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	pub fn register_async(&self, ) -> Result<::ipcdefs::nn::account::detail::IAsyncContext<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn unregister_async(&self, ) -> Result<::ipcdefs::nn::account::detail::IAsyncContext<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn synchronize_profile_async(&self, ) -> Result<::ipcdefs::nn::account::detail::IAsyncContext<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn upload_profile_async(&self, ) -> Result<::ipcdefs::nn::account::detail::IAsyncContext<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn synchronize_profile_async_if_seconds_elapsed(&self, unk0: u32) -> Result<(bool, ::ipcdefs::nn::account::detail::IAsyncContext<T>)> {
		use ::ipc::{Request, Response};
	...
	pub fn create_procedure_to_link_with_nintendo_account(&self, ) -> Result<::ipcdefs::nn::account::nas::IOAuthProcedureForNintendoAccountLinkage<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn resume_procedure_to_link_with_nintendo_account(&self, unk0: ::ipcdefs::nn::account::detail::Uuid) -> Result<::ipcdefs::nn::account::nas::IOAuthProcedureForNintendoAccountLinkage<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn create_procedure_to_update_linkage_state_of_nintendo_account(&self, ) -> Result<::ipcdefs::nn::account::http::IOAuthProcedure<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn resume_procedure_to_update_linkage_state_of_nintendo_account(&self, unk0: ::ipcdefs::nn::account::detail::Uuid) -> Result<::ipcdefs::nn::account::http::IOAuthProcedure<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn create_procedure_to_link_nnid_with_nintendo_account(&self, ) -> Result<::ipcdefs::nn::account::http::IOAuthProcedure<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn resume_procedure_to_link_nnid_with_nintendo_account(&self, unk0: ::ipcdefs::nn::account::detail::Uuid) -> Result<::ipcdefs::nn::account::http::IOAuthProcedure<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn proxy_procedure_to_acquire_application_authorization_for_nintendo_account(&self, unk0: ::ipcdefs::nn::account::detail::Uuid) -> Result<::ipcdefs::nn::account::http::IOAuthProcedure<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn debug_unlink_nintendo_account_async(&self, ) -> Result<::ipcdefs::nn::account::detail::IAsyncContext<T>> {
		use ::ipc::{Request, Response};
