...
impl<T: Object> ISystemClock<T> {
	pub fn get_current_time(&self, ) -> Result<::ipcdefs::nn::time::PosixTime> {
	...
	pub fn set_current_time(&self, unk0: ::ipcdefs::nn::time::PosixTime) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	pub fn get_system_clock_context(&self, ) -> Result<::ipcdefs::nn::time::SystemClockContext> {
		use ::ipc::{Request, Response};
	...
	pub fn set_system_clock_context(&self, unk0: ::ipcdefs::nn::time::SystemClockContext) -> Result<()> {
		use ::ipc::{Request, Response};
