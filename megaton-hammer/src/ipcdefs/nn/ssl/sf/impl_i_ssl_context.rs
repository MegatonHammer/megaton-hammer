...
impl<T: Object> ISslContext<T> {
	pub fn set_option(&self, unk0: ::ipcdefs::nn::ssl::sf::ContextOption, unk1: i32) -> Result<()> {
		use ::ipc::{Request, Response};

		#[repr(C)] #[derive(Clone)]
		struct InRaw {
			unk0: ::ipcdefs::nn::ssl::sf::ContextOption,
			unk1: i32,
		}
	...
	pub fn get_option(&self, unk0: ::ipcdefs::nn::ssl::sf::ContextOption) -> Result<i32> {
		use ::ipc::{Request, Response};
	...
	pub fn create_connection(&self, ) -> Result<::ipcdefs::nn::ssl::sf::ISslConnection<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn register_internal_pki(&self, unk0: ::ipcdefs::nn::ssl::sf::InternalPki) -> Result<u64> {
		use ::ipc::{Request, Response};
