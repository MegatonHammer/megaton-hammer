...
impl<T: Object> INotificationService<T> {
	...
	pub fn pop(&self, ) -> Result<::ipcdefs::nn::friends::detail::ipc::SizedNotificationInfo> {
		use ::ipc::{Request, Response};

		let req : Request<_, [_; 0], [_; 0], [_; 0]> = Request::new(2)
			.args(())
			;
		let res : Response<::ipcdefs::nn::friends::detail::ipc::SizedNotificationInfo> = self.0.send(req)?;
		Ok(*res.get_raw())
	}
