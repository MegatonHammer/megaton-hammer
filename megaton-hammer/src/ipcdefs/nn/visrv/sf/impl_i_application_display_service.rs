...
impl<T: Object> IApplicationDisplayService<T> {
	pub fn get_relay_service(&self, ) -> Result<::ipcdefs::nns::hosbinder::IHOSBinderDriver<T>> {
	...
	pub fn get_system_display_service(&self, ) -> Result<::ipcdefs::nn::visrv::sf::ISystemDisplayService<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn get_manager_display_service(&self, ) -> Result<::ipcdefs::nn::visrv::sf::IManagerDisplayService<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn get_indirect_display_transaction_service(&self, ) -> Result<::ipcdefs::nns::hosbinder::IHOSBinderDriver<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn list_displays(&self, unk1: &mut [::ipcdefs::nn::vi::DisplayInfo]) -> Result<i64> {
		use ::ipc::IPCBuffer;
		use ::ipc::{Request, Response};
	...
	pub fn open_display(&self, unk0: ::ipcdefs::nn::vi::DisplayName) -> Result<u64> {
		use ::ipc::{Request, Response};
	...
	pub fn open_layer(&self, unk0: ::ipcdefs::nn::vi::DisplayName, unk1: u64, unk2: ::ipcdefs::nn::applet::AppletResourceUserId, unk5: &mut [u8]) -> Result<i64> {
		use ::ipc::IPCBuffer;
		use ::ipc::{Request, Response};

		#[repr(C)] #[derive(Clone)]
		struct InRaw {
			unk0: ::ipcdefs::nn::vi::DisplayName,
			unk1: u64,
