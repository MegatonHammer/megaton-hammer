...
impl<T: Object> IStorage<T> {
	pub fn open(&self, ) -> Result<::ipcdefs::nn::am::service::IStorageAccessor<T>> {
	...
	pub fn open_transfer_storage(&self, ) -> Result<::ipcdefs::nn::am::service::ITransferStorageAccessor<T>> {
		use ::ipc::{Request, Response};
