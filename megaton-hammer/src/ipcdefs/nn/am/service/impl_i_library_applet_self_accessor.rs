...
impl<T: Object> ILibraryAppletSelfAccessor<T> {
	pub fn pop_in_data(&self, ) -> Result<::ipcdefs::nn::am::service::IStorage<T>> {
	...
	pub fn push_out_data(&self, unk0: &::ipcdefs::nn::am::service::IStorage<Session>) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	pub fn pop_interactive_in_data(&self, ) -> Result<::ipcdefs::nn::am::service::IStorage<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn push_interactive_out_data(&self, unk0: &::ipcdefs::nn::am::service::IStorage<Session>) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	pub fn get_main_applet_identity_info(&self, ) -> Result<::ipcdefs::nn::am::service::AppletIdentityInfo> {
		use ::ipc::{Request, Response};

		let req : Request<_, [_; 0], [_; 0], [_; 0]> = Request::new(12)
			.args(())
			;
		let res : Response<::ipcdefs::nn::am::service::AppletIdentityInfo> = self.0.send(req)?;
		Ok(*res.get_raw())
	}
	...
	pub fn get_caller_applet_identity_info(&self, ) -> Result<::ipcdefs::nn::am::service::AppletIdentityInfo> {
		use ::ipc::{Request, Response};
	...
	pub fn get_main_applet_application_control_property(&self, unk0: &mut ::ipcdefs::nn::ns::ApplicationControlProperty) -> Result<()> {
		use ::ipc::IPCBuffer;
		use ::ipc::{Request, Response};
	...
	pub fn get_main_applet_storage_id(&self, ) -> Result<::ipcdefs::nn::ncm::StorageId> {
		use ::ipc::{Request, Response};

		let req : Request<_, [_; 0], [_; 0], [_; 0]> = Request::new(16)
			.args(())
			;
		let res : Response<::ipcdefs::nn::ncm::StorageId> = self.0.send(req)?;
		Ok(*res.get_raw())
	}

	pub fn get_caller_applet_identity_info_stack(&self, unk1: &mut [::ipcdefs::nn::am::service::AppletIdentityInfo]) -> Result<i32> {
		use ::ipc::IPCBuffer;
		use ::ipc::{Request, Response};
	...
	pub fn pop_extra_storage(&self, ) -> Result<::ipcdefs::nn::am::service::IStorage<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn unpop_in_data(&self, unk0: &::ipcdefs::nn::am::service::IStorage<Session>) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	pub fn unpop_extra_storage(&self, unk0: &::ipcdefs::nn::am::service::IStorage<Session>) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	pub fn report_visible_error(&self, unk0: ::ipcdefs::nn::err::ErrorCode) -> Result<()> {
		use ::ipc::{Request, Response};
