...
impl<T: Object> ILibraryAppletCreator<T> {
	pub fn create_library_applet(&self, unk0: u32, unk1: u32) -> Result<::ipcdefs::nn::am::service::ILibraryAppletAccessor<T>> {
	...
	pub fn create_storage(&self, unk0: i64) -> Result<::ipcdefs::nn::am::service::IStorage<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn create_transfer_memory_storage(&self, unk0: bool, unk1: i64, unk2: &KObject) -> Result<::ipcdefs::nn::am::service::IStorage<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn create_handle_storage(&self, unk0: i64, unk1: &KObject) -> Result<::ipcdefs::nn::am::service::IStorage<T>> {
		use ::ipc::{Request, Response};
