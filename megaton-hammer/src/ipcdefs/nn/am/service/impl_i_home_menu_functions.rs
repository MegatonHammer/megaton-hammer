...
impl<T: Object> IHomeMenuFunctions<T> {
	...
	pub fn pop_from_general_channel(&self, ) -> Result<::ipcdefs::nn::am::service::IStorage<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn get_home_button_writer_lock_accessor(&self, ) -> Result<::ipcdefs::nn::am::service::ILockAccessor<T>> {
		use ::ipc::{Request, Response};
	...
	pub fn get_writer_lock_accessor_ex(&self, unk0: i32) -> Result<::ipcdefs::nn::am::service::ILockAccessor<T>> {
		use ::ipc::{Request, Response};
