...
impl<T: Object> IApplicationFunctions<T> {
	pub fn pop_launch_parameter(&self, unk0: u32) -> Result<::ipcdefs::nn::am::service::IStorage<T>> {
	...
	pub fn create_application_and_push_and_request_to_start(&self, unk0: ::ipcdefs::nn::ncm::ApplicationId, unk1: &::ipcdefs::nn::am::service::IStorage<Session>) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	pub fn create_application_and_push_and_request_to_start_for_quest(&self, unk0: u32, unk1: u32, unk2: ::ipcdefs::nn::ncm::ApplicationId, unk3: &::ipcdefs::nn::am::service::IStorage<Session>) -> Result<()> {
		use ::ipc::{Request, Response};
	...
	pub fn ensure_save_data(&self, unk0: ::ipcdefs::nn::account::Uid) -> Result<i64> {
		use ::ipc::{Request, Response};
	...
	pub fn get_desired_language(&self, ) -> Result<::ipcdefs::nn::settings::LanguageCode> {
		use ::ipc::{Request, Response};
	...
	pub fn get_display_version(&self, ) -> Result<::ipcdefs::nn::oe::DisplayVersion> {
		use ::ipc::{Request, Response};

		let req : Request<_, [_; 0], [_; 0], [_; 0]> = Request::new(23)
			.args(())
			;
		let res : Response<::ipcdefs::nn::oe::DisplayVersion> = self.0.send(req)?;
		Ok(*res.get_raw())
	}

	pub fn get_launch_storage_info_for_debug(&self, ) -> Result<(::ipcdefs::nn::ncm::StorageId, ::ipcdefs::nn::ncm::StorageId)> {
		use ::ipc::{Request, Response};
		...
		#[repr(C)] #[derive(Clone)] struct OutRaw {
			unk0: ::ipcdefs::nn::ncm::StorageId,
			unk1: ::ipcdefs::nn::ncm::StorageId,
		}
		let res : Response<OutRaw> = self.0.send(req)?;
		Ok((res.get_raw().unk0.clone(),res.get_raw().unk1.clone()))
	}

	pub fn extend_save_data(&self, unk0: u8, unk1: ::ipcdefs::nn::account::Uid, unk2: i64, unk3: i64) -> Result<i64> {
		use ::ipc::{Request, Response};
	...
	pub fn get_save_data_size(&self, unk0: u8, unk1: ::ipcdefs::nn::account::Uid) -> Result<(i64, i64)> {
		use ::ipc::{Request, Response};
	...
	pub fn get_pseudo_device_id(&self, ) -> Result<::ipcdefs::nn::util::Uuid> {
		use ::ipc::{Request, Response};
