...
impl<T: Object> ILocationResolver<T> {
	...
	// fn set_program_nca_path2(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn clear_location_resolver2(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn delete_program_nca_path(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn delete_control_nca_path(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn delete_doc_html_nca_path(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn delete_info_html_nca_path(&self, UNKNOWN) -> Result<UNKNOWN>;
}
