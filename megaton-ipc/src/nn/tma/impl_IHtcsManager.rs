...
impl IHtcsManager {
	...
	pub fn Unknown2(&self, unk0: [u8; 0x42], unk1: u32) -> Result<(u32, u32)> {
		#[repr(C)] #[derive(Clone)]
		struct InRaw {
			unk0: [u8; 0x42],
			unk1: u32,
	...
	pub fn Unknown3(&self, unk0: [u8; 0x42], unk1: u32) -> Result<(u32, u32)> {
		#[repr(C)] #[derive(Clone)]
		struct InRaw {
			unk0: [u8; 0x42],
			unk1: u32,
	...
	pub fn Unknown5(&self, unk0: u32) -> Result<([u8; 0x42], u32, u32)> {
	...
	pub fn Unknown10(&self, ) -> Result<[u8; 0x20]> {
	...
	pub fn Unknown11(&self, ) -> Result<[u8; 0x20]> {
