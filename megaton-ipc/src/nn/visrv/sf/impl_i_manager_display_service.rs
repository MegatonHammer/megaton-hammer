...
impl<T: Object> IManagerDisplayService<T> {
	...
	pub fn create_managed_layer(&self, unk0: u32, unk1: u64, unk2: ::nn::applet::AppletResourceUserId) -> Result<u64> {
		use megaton_hammer::ipc::{Request, Response};
	...
	pub fn create_indirect_producer_end_point(&self, unk0: u64, unk1: ::nn::applet::AppletResourceUserId) -> Result<u64> {
		use megaton_hammer::ipc::{Request, Response};
	...
	pub fn create_indirect_consumer_end_point(&self, unk0: u64, unk1: ::nn::applet::AppletResourceUserId) -> Result<u64> {
		use megaton_hammer::ipc::{Request, Response};
	...
	pub fn set_indirect_producer_flip_offset(&self, unk0: u64, unk1: u64, unk2: ::nn::TimeSpan) -> Result<()> {
		use megaton_hammer::ipc::{Request, Response};
