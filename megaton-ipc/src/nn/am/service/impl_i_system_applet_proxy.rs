...
impl ISystemAppletProxy {
	...
	pub fn get_home_menu_functions(&self, ) -> Result<::nn::am::service::IHomeMenuFunctions> {
		use megaton_hammer::ipc::{Request, Response};
	...
	pub fn get_global_state_controller(&self, ) -> Result<::nn::am::service::IGlobalStateController> {
		use megaton_hammer::ipc::{Request, Response};
	...
	pub fn get_application_creator(&self, ) -> Result<::nn::am::service::IApplicationCreator> {
		use megaton_hammer::ipc::{Request, Response};
