...
impl ILibraryAppletSelfAccessor {
	...
	// fn GetPopInDataEvent(&self, UNKNOWN) -> Result<UNKNOWN>;
	// fn GetPopInteractiveInDataEvent(&self, UNKNOWN) -> Result<UNKNOWN>;
	...
	// fn GetPopExtraStorageEvent(&self, UNKNOWN) -> Result<UNKNOWN>;
